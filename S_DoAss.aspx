...
*	File:					S_DoAss.aspx
*	Description:		Page for doing assignment.
*
*	Designer:		LIU MINGCHEN 
*	ID:					17098537-I011-0055
*	E-mail:			504393241@qq.com
--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="S_DoAss.aspx.cs" Inherits="S_DoAss" %>
...
<body>
   ...
   <nav class="navbar navbar-inverse" role="navigation">
    ...
    <div class="container">
       <div class="jumbotron">
            <h1 class="text-center">Do Assignment</h1>
            <p class="text-center"><strong>Assignment <%=aid %></strong> <br />Doing assignment below. 
                Finally, click 'Submit' button. Then click 'Next Assignment' button for new assignment</p>
       </div>
    </div>
    
     <form runat="server">
         <%--refresh to get next assignment--%>
         &nbsp;&nbsp;
         <asp:Button runat="server" text="Next Assignment" class="btn btn-primary btn-lg" ></asp:Button>
         <br />
         <br />
         <%-- print question and weight  --%>
		            ...
		            <div id="collapseOne" class="panel-collapse collapse">
			            <div class="panel-body">
	                        ...
	                        <div class="form-group"> <br />
                                <%-- answer box --%>
                                <asp:textbox runat="server" MaxLength="500" TextMode="MultiLine" id="a1" class="form-control" rows="10"></asp:textbox>
	                        </div>
			            </div>
		            </div>
	            </div>
                ...
                <%get_Ass(2); %>
		            <div id="collapseTwo" class="panel-collapse collapse">
			            <div class="panel-body">
	                        ...
	                        <div class="form-group"> <br />
                                <asp:textbox runat="server" MaxLength="500" TextMode="MultiLine" id="a2" class="form-control" rows="10"></asp:textbox>
	                        </div>
			            </div>
		            </div>
	            </div>
                ...
                <%get_Ass(3); %>
		            <div id="collapseThree" class="panel-collapse collapse">
			            <div class="panel-body">
	                        ...
	                        <div class="form-group"> <br />
                                <asp:textbox runat="server" MaxLength="500" TextMode="MultiLine" id="a3" class="form-control" rows="10"></asp:textbox>
	                        </div>
			            </div>
		            </div>
	            </div>
                ...
                <%get_Ass(4); %>
		            <div id="collapseFour" class="panel-collapse collapse">
			            <div class="panel-body">
	                        ...
	                        <div class="form-group"> <br />
                                <asp:textbox runat="server" MaxLength="500" TextMode="MultiLine" id="a4" class="form-control" rows="10"></asp:textbox>
	                        </div>
			            </div>
		            </div>
	            </div>
                ...
                <%get_Ass(5); %>
		            <div id="collapseFive" class="panel-collapse collapse">
			            <div class="panel-body">
	                        ...
	                        <div class="form-group"> <br />
                                <asp:textbox runat="server" MaxLength="500" TextMode="MultiLine" id="a5" class="form-control" rows="10"></asp:textbox>
	                        </div>
			            </div>
		            </div>
	            </div>
